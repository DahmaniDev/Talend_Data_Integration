...
package etl_pib.dim_profile_0_1;
 ...
 * @status
 */
public class Dim_Profile implements TalendJob {
	...
	private final String jobName = "Dim_Profile";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Dim_Profile.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class Dim_ProfilingStruct implements routines.system.IPersistableRow<Dim_ProfilingStruct> {
		final static byte[] commonByteArrayLock_ETL_PIB_Dim_Profile = new byte[0];
		static byte[] commonByteArray_ETL_PIB_Dim_Profile = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final Dim_ProfilingStruct other = (Dim_ProfilingStruct) obj;
		...
		public void copyDataTo(Dim_ProfilingStruct other) {
		...
		public void copyKeysDataTo(Dim_ProfilingStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ETL_PIB_Dim_Profile.length) {
					if (length < 1024 && commonByteArray_ETL_PIB_Dim_Profile.length == 0) {
						commonByteArray_ETL_PIB_Dim_Profile = new byte[1024];
					} else {
						commonByteArray_ETL_PIB_Dim_Profile = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ETL_PIB_Dim_Profile, 0, length);
				strReturn = new String(commonByteArray_ETL_PIB_Dim_Profile, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PIB_Dim_Profile) {
		 ...
		 * Compare keys
		 */
		public int compareTo(Dim_ProfilingStruct other) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Dim_ProfilingStruct Dim_Profiling = new Dim_ProfilingStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "Dim_Profiling");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("Dim_Profiling");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Dim_Profiling");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:OusavDOQ1MABbfmqRbULr0tGjsE8E0hehFhlyOQMVY4=");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Dim_Profiling"))
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
							+ "\"(\"ProfileID\" INT4  not null ,\"Type\" VARCHAR(10)  ,\"Sexe\" VARCHAR(7)  ,\"Age\" VARCHAR(5)  ,\"Marital_Status\" VARCHAR(8)  ,primary key(\"ProfileID\"))");
				}
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"ProfileID\",\"Type\",\"Sexe\",\"Age\",\"Marital_Status\") VALUES (?,?,?,?,?)";
...
// # Outputs initialization
				Dim_ProfilingStruct Dim_Profiling_tmp = new Dim_ProfilingStruct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:7Cuwzo30GhsyH2OT0yiph+baNRYm18954I+M1Q==");
				...
				Object source_tFileInputExcel_1 = "D:/PIB/Data/Profiling.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									curColName_tFileInputExcel_1 = "Profile_Code";

									row1.Profile_Code = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.Sexe = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Sexe = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.Age = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Age = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Marital_Status";

									row1.Marital_Status = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Change_Freq";

									row1.Change_Freq = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
									row1.Change_Freq = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Services_Sat_Rate_On5";

									row1.Services_Sat_Rate_On5 = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
									row1.Services_Sat_Rate_On5 = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Complain_Sat_Rate";

									row1.Complain_Sat_Rate = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
									row1.Complain_Sat_Rate = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Res_Time_Days_Expected";

									row1.Res_Time_Days_Expected = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
									row1.Res_Time_Days_Expected = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Price_Sat_Rate";

									row1.Price_Sat_Rate = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
									row1.Price_Sat_Rate = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// # Output table : 'Dim_Profiling'
									Dim_Profiling_tmp.ProfileID = row1.Profile_Code;
									Dim_Profiling_tmp.Type = row1.Type;
									Dim_Profiling_tmp.Sexe = row1.Sexe;
									Dim_Profiling_tmp.Age = row1.Age;
									Dim_Profiling_tmp.Marital_Status = row1.Marital_Status;
									Dim_Profiling = Dim_Profiling_tmp;
// ###############################
								 ...
								 */
// Start of branch "Dim_Profiling"
								if (Dim_Profiling != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(iterateId, 1, 1, "Dim_Profiling");
									}

									whetherReject_tDBOutput_1 = false;
									pstmt_tDBOutput_1.setInt(1, Dim_Profiling.ProfileID);

									if (Dim_Profiling.Type == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, Dim_Profiling.Type);
									}

									if (Dim_Profiling.Sexe == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, Dim_Profiling.Sexe);
									}

									if (Dim_Profiling.Age == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(4, Dim_Profiling.Age);
									}

									if (Dim_Profiling.Marital_Status == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(5, Dim_Profiling.Marital_Status);
									}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "Dim_Profiling");
				}
	...
	public static void main(String[] args) {
		final Dim_Profile Dim_ProfileClass = new Dim_Profile();

		int exitCode = Dim_ProfileClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Profile.class.getClassLoader()
					.getResourceAsStream("etl_pib/dim_profile_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Profile.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Profile");
		}
...
/************************************************************************************************
 * 73405 characters generated by Talend Open Studio for Data Integration on the
 * April 3, 2022 12:19:36 AM BST
 ************************************************************************************************/