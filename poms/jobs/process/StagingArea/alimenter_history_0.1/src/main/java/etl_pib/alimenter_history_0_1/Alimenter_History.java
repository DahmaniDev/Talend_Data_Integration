...
package etl_pib.alimenter_history_0_1;
...
/**
 * Job: Alimenter_History Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Alimenter_History implements TalendJob {
	...
	private final String jobName = "Alimenter_History";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Alimenter_History.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Alimenter_History.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class historyStruct implements routines.system.IPersistableRow<historyStruct> {
		final static byte[] commonByteArrayLock_ETL_PIB_Alimenter_History = new byte[0];
		static byte[] commonByteArray_ETL_PIB_Alimenter_History = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PIB_Alimenter_History) {
				...
				try {
					...
					this.ComplaintID = readInteger(dis);

					this.ComplaintStatusID = readInteger(dis);

					this.StatusDate = readDate(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.ComplaintID, dos);

				// Integer

				writeInteger(this.ComplaintStatusID, dos);

				// java.util.Date

				writeDate(this.StatusDate, dos);
		...
		public String toString() {
			...
			sb.append(",ComplaintID=" + String.valueOf(ComplaintID));
			sb.append(",ComplaintStatusID=" + String.valueOf(ComplaintStatusID));
			sb.append(",StatusDate=" + String.valueOf(StatusDate));
			sb.append("]");
		 ...
		 * Compare keys
		 */
		public int compareTo(historyStruct other) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				historyStruct history = new historyStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "history");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("Complain_History");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Complain_History");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:IizGPhUZjIKRONt3i7HBf637FtfKu8bxrtGSozCNkjc=");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Complain_History"))
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
							+ "\"(\"ID\" INT4 ,\"ComplaintID\" INT4 ,\"ComplaintStatusID\" INT4 ,\"StatusDate\" DATE )");
				}
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"ID\",\"ComplaintID\",\"ComplaintStatusID\",\"StatusDate\") VALUES (?,?,?,?)";
...
// # Outputs initialization
				historyStruct history_tmp = new historyStruct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:qJBU5Gt/DvclPoGbZKIs6zTdmcuIG2kKF6Rlww==");
				...
				Object source_tFileInputExcel_1 = "D:/PIB/Data/History.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "ComplaintID";

									row1.ComplaintID = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
									row1.ComplaintID = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "ComplaintStatusID";

									row1.ComplaintStatusID = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
									row1.ComplaintStatusID = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "StatusDate";
											...
											if (row_tFileInputExcel_1
													...
													&& org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(
															row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1
																	+ start_column_tFileInputExcel_1))) {
												row1.StatusDate = row_tFileInputExcel_1.getCell(
												...
												if (tempDate_tFileInputExcel_1
													...
													row1.StatusDate = tempDate_tFileInputExcel_1;
												}
											}
...
// # Output table : 'history'
									history_tmp.ID = row1.ID;
									history_tmp.ComplaintID = row1.ComplaintID;
									history_tmp.ComplaintStatusID = row1.ComplaintStatusID;
									history_tmp.StatusDate = row1.StatusDate;
									history = history_tmp;
// ###############################
...
// Start of branch "history"
								if (history != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(iterateId, 1, 1, "history");
									}
									...
									if (history.ID == null) {
										...
										pstmt_tDBOutput_1.setInt(1, history.ID);
									}

									if (history.ComplaintID == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(2, history.ComplaintID);
									}

									if (history.ComplaintStatusID == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(3, history.ComplaintStatusID);
									}

									if (history.StatusDate != null) {
										pstmt_tDBOutput_1.setTimestamp(4,
												new java.sql.Timestamp(history.StatusDate.getTime()));
									} else {
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "history");
				}
	...
	public static void main(String[] args) {
		final Alimenter_History Alimenter_HistoryClass = new Alimenter_History();

		int exitCode = Alimenter_HistoryClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Alimenter_History.class.getClassLoader()
					.getResourceAsStream("etl_pib/alimenter_history_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Alimenter_History.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Alimenter_History");
		}
...
/************************************************************************************************
 * 66049 characters generated by Talend Open Studio for Data Integration on the
 * March 10, 2022 9:29:28 PM CET
 ************************************************************************************************/