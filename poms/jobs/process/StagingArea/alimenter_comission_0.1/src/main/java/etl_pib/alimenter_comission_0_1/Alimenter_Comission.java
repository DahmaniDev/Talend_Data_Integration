...
package etl_pib.alimenter_comission_0_1;
...
/**
 * Job: Alimenter_Comission Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Alimenter_Comission implements TalendJob {
	...
	private final String jobName = "Alimenter_Comission";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Alimenter_Comission.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Alimenter_Comission.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class ComissionStruct implements routines.system.IPersistableRow<ComissionStruct> {
		final static byte[] commonByteArrayLock_ETL_PIB_Alimenter_Comission = new byte[0];
		static byte[] commonByteArray_ETL_PIB_Alimenter_Comission = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ETL_PIB_Alimenter_Comission.length) {
					if (length < 1024 && commonByteArray_ETL_PIB_Alimenter_Comission.length == 0) {
						commonByteArray_ETL_PIB_Alimenter_Comission = new byte[1024];
					} else {
						commonByteArray_ETL_PIB_Alimenter_Comission = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ETL_PIB_Alimenter_Comission, 0, length);
				strReturn = new String(commonByteArray_ETL_PIB_Alimenter_Comission, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PIB_Alimenter_Comission) {

				try {

					int length = 0;

					this.Comm_ref = readString(dis);
		 ...
		 * Compare keys
		 */
		public int compareTo(ComissionStruct other) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ComissionStruct Comission = new ComissionStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "Comission");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("Commission");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Commission");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:4yvD3HWQttnASBpvAowsPa7puGEhYxeFUKsMxpWCAOE=");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Commission")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
							+ "\"(\"Comm_ref\" VARCHAR(6)  ,\"Commission\" VARCHAR(13)  )");
				}
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"Comm_ref\",\"Commission\") VALUES (?,?)";
...
// # Outputs initialization
				ComissionStruct Comission_tmp = new ComissionStruct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:sX4wcwL4Cr4GEZd0dJxN1gZUuZbKwiLyRDerbQ==");
				...
				Object source_tFileInputExcel_1 = "D:/PIB/Data/Comission.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									curColName_tFileInputExcel_1 = "Comm_ref";

									row1.Comm_ref = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Comm_ref = null;
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Commission";

									row1.Commission = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
...
// # Output table : 'Comission'
									Comission_tmp.Comm_ref = row1.Comm_ref;
									Comission_tmp.Commission = row1.Commission;
...
// Start of branch "Comission"
								if (Comission != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(iterateId, 1, 1, "Comission");
									}

									whetherReject_tDBOutput_1 = false;
									if (Comission.Comm_ref == null) {
										pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(1, Comission.Comm_ref);
									}

									if (Comission.Commission == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, Comission.Commission);
									}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "Comission");
				}
	...
	public static void main(String[] args) {
		final Alimenter_Comission Alimenter_ComissionClass = new Alimenter_Comission();

		int exitCode = Alimenter_ComissionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Alimenter_Comission.class.getClassLoader()
					.getResourceAsStream("etl_pib/alimenter_comission_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Alimenter_Comission.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Alimenter_Comission");
		}
...
/************************************************************************************************
 * 61445 characters generated by Talend Open Studio for Data Integration on the
 * March 10, 2022 3:30:42 PM CET
 ************************************************************************************************/