...
package etl_pib.alimenter_customers_dim_0_1;
...
/**
 * Job: alimenter_Customers_Dim Purpose: <br>
 * Description: <br>
 * 
 * @author
 ...
 * @status
 */
public class alimenter_Customers_Dim implements TalendJob {
	...
	private final String jobName = "alimenter_Customers_Dim";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					alimenter_Customers_Dim.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(alimenter_Customers_Dim.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class Customers_outputStruct implements routines.system.IPersistableRow<Customers_outputStruct> {
		final static byte[] commonByteArrayLock_ETL_PIB_alimenter_Customers_Dim = new byte[0];
		static byte[] commonByteArray_ETL_PIB_alimenter_Customers_Dim = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final Customers_outputStruct other = (Customers_outputStruct) obj;
		...
		public void copyDataTo(Customers_outputStruct other) {
		...
		public void copyKeysDataTo(Customers_outputStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ETL_PIB_alimenter_Customers_Dim.length) {
					if (length < 1024 && commonByteArray_ETL_PIB_alimenter_Customers_Dim.length == 0) {
						commonByteArray_ETL_PIB_alimenter_Customers_Dim = new byte[1024];
					} else {
						commonByteArray_ETL_PIB_alimenter_Customers_Dim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ETL_PIB_alimenter_Customers_Dim, 0, length);
				strReturn = new String(commonByteArray_ETL_PIB_alimenter_Customers_Dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PIB_alimenter_Customers_Dim) {
		 ...
		 * Compare keys
		 */
		public int compareTo(Customers_outputStruct other) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Customers_outputStruct Customers_output = new Customers_outputStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "Customers_output");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					...
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Customers");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:zDlShGWX83X+R+e4hokFR1xK5WtWdzk97FWLpiPlZyw=");
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
							+ "\"(\"CustomerID\" INT4 ,\"LastName\" VARCHAR(250)  ,\"FirstName\" VARCHAR(250)  ,\"BirthDate\" TIMESTAMP(29)  ,\"Gender\" VARCHAR(6)  ,\"ParticipantType\" VARCHAR(10)  ,\"RegionID\" INT4 ,\"MaritalStatus\" VARCHAR(8)  ,primary key(\"CustomerID\"))");
				}
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"CustomerID\",\"LastName\",\"FirstName\",\"BirthDate\",\"Gender\",\"ParticipantType\",\"RegionID\",\"MaritalStatus\") VALUES (?,?,?,?,?,?,?,?)";
...
// # Outputs initialization
				Customers_outputStruct Customers_output_tmp = new Customers_outputStruct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:iHAmrSS3pd70fE7xoBQlAVcwBxJMyfewqw3Qmg==");
				...
				Object source_tFileInputExcel_1 = "D:/PIB/Data/Customers.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
											...
											if (row_tFileInputExcel_1
													...
													&& org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(
															row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1
																	+ start_column_tFileInputExcel_1))) {
												row1.BirthDate = row_tFileInputExcel_1.getCell(
												...
												if (tempDate_tFileInputExcel_1
													...
													row1.BirthDate = tempDate_tFileInputExcel_1;
												}
											}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "ParticipantType";

									row1.ParticipantType = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "RegionID";

									row1.RegionID = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "MaritalStatus";

									row1.MaritalStatus = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
...
// Start of branch "row1"
							if (row1 != null) {
								...
								{ // start of Var scope
									...
									Customers_output = null;

// # Output table : 'Customers_output'
									Customers_output_tmp.CustomerID = row1.CustomerID;
									Customers_output_tmp.LastName = row1.LastName;
									Customers_output_tmp.FirstName = row1.FirstName;
									Customers_output_tmp.BirthDate = row1.BirthDate;
									Customers_output_tmp.Gender = row1.Gender;
									Customers_output_tmp.ParticipantType = row1.ParticipantType;
									Customers_output_tmp.RegionID = row1.RegionID;
									Customers_output_tmp.MaritalStatus = row1.MaritalStatus;
									Customers_output = Customers_output_tmp;
// ###############################
								 ...
								 */
// Start of branch "Customers_output"
								if (Customers_output != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(iterateId, 1, 1, "Customers_output");
									}

									whetherReject_tDBOutput_1 = false;
									if (Customers_output.CustomerID == null) {
										pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(1, Customers_output.CustomerID);
									}

									if (Customers_output.LastName == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, Customers_output.LastName);
									}

									if (Customers_output.FirstName == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, Customers_output.FirstName);
									}

									if (Customers_output.BirthDate != null) {
										pstmt_tDBOutput_1.setTimestamp(4,
												new java.sql.Timestamp(Customers_output.BirthDate.getTime()));
									} else {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.TIMESTAMP);
									}

									if (Customers_output.Gender == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(5, Customers_output.Gender);
									}

									if (Customers_output.ParticipantType == null) {
										pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(6, Customers_output.ParticipantType);
									}

									if (Customers_output.RegionID == null) {
										pstmt_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(7, Customers_output.RegionID);
									}

									if (Customers_output.MaritalStatus == null) {
										pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(8, Customers_output.MaritalStatus);
									}
								...
								} // End of branch "Customers_output"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "Customers_output");
				}
	...
	public static void main(String[] args) {
		final alimenter_Customers_Dim alimenter_Customers_DimClass = new alimenter_Customers_Dim();

		int exitCode = alimenter_Customers_DimClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = alimenter_Customers_Dim.class.getClassLoader()
					.getResourceAsStream("etl_pib/alimenter_customers_dim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = alimenter_Customers_Dim.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : alimenter_Customers_Dim");
		}
...
/************************************************************************************************
 * 73070 characters generated by Talend Open Studio for Data Integration on the
 * March 10, 2022 4:39:47 PM CET
 ************************************************************************************************/