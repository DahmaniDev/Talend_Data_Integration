...
package etl_pib.alimenter_statuses_0_1;
...
/**
 * Job: Alimenter_Statuses Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Alimenter_Statuses implements TalendJob {
	...
	private final String jobName = "Alimenter_Statuses";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Alimenter_Statuses.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Alimenter_Statuses.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class statusesStruct implements routines.system.IPersistableRow<statusesStruct> {
		final static byte[] commonByteArrayLock_ETL_PIB_Alimenter_Statuses = new byte[0];
		static byte[] commonByteArray_ETL_PIB_Alimenter_Statuses = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ETL_PIB_Alimenter_Statuses.length) {
					if (length < 1024 && commonByteArray_ETL_PIB_Alimenter_Statuses.length == 0) {
						commonByteArray_ETL_PIB_Alimenter_Statuses = new byte[1024];
					} else {
						commonByteArray_ETL_PIB_Alimenter_Statuses = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ETL_PIB_Alimenter_Statuses, 0, length);
				strReturn = new String(commonByteArray_ETL_PIB_Alimenter_Statuses, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ETL_PIB_Alimenter_Statuses) {
		 ...
		 * Compare keys
		 */
		public int compareTo(statusesStruct other) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				statusesStruct statuses = new statusesStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "statuses");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("Statuses");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Statuses");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:E5r8I7Np21aran0YURSim8RPTVli3V6dJE3G665zb00=");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Statuses")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
							+ "\"(\"ID\" INT4 ,\"Description\" VARCHAR(11)  )");
				}
...
// # Outputs initialization
				statusesStruct statuses_tmp = new statusesStruct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:1HKMm+To2Sm339SaI25MQWtwrM/foi6TIit1jw==");
				...
				Object source_tFileInputExcel_1 = "D:/PIB/Data/Statuses.xlsx";
...
// # Output table : 'statuses'
									statuses_tmp.ID = row1.ID;
									statuses_tmp.Description = row1.Description;
...
// Start of branch "statuses"
								if (statuses != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(iterateId, 1, 1, "statuses");
									}
									...
									if (statuses.ID == null) {
										...
										pstmt_tDBOutput_1.setInt(1, statuses.ID);
									}

									if (statuses.Description == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, statuses.Description);
									}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "statuses");
				}
	...
	public static void main(String[] args) {
		final Alimenter_Statuses Alimenter_StatusesClass = new Alimenter_Statuses();

		int exitCode = Alimenter_StatusesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Alimenter_Statuses.class.getClassLoader()
					.getResourceAsStream("etl_pib/alimenter_statuses_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Alimenter_Statuses.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Alimenter_Statuses");
		}
...
/************************************************************************************************
 * 62430 characters generated by Talend Open Studio for Data Integration on the
 * March 10, 2022 5:08:35 PM CET
 ************************************************************************************************/